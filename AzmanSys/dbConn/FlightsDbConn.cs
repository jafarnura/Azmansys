...
namespace AzmanSys
{
    class FlightsDbConn : dbConn
    {
        public void insertFlight(string F_Depar_DateTime, string F_Arrival_DateTime, string F_Departure_City, string F_Arrival_City, string F_Price)
        {
            ...
            comm.CommandText = " INSERT INTO `tblFlight`(`F_Depar_DateTime`, `F_Arrival_DateTime`, `F_Departure_City`, `F_Arrival_City`, `F_Price`) VALUES " +
                " (@F_Depar_DateTime, @F_Arrival_DateTime, @F_Departure_City, @F_Arrival_City, @F_Price);";
